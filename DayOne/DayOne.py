...
# # /!\ There is currently an issue with GitHub authentication; if it does not work, please try again later. /!\
from os import path
import sys
...
#             # print(instruction)
#         # for instruction in attachedDoc:
#             currentDirection = instruction[0]
#             # print(currentDirection)
#             currentDistance = int(instruction[1::])
#             # print(currentDistance)
#             currentPosition, calc_zeros = rotateCalc(currentDirection, int(currentDistance), int(currentPosition))
            
            
#             # currentPosition = rotateCalcCountZeros(currentDirection, int(currentDistance), int(currentPosition), counter)
#             # print(get_dial_instruction(int(currentDistance), int(currentPosition)))
#             # print(currentPosition)
#             # password += currentPosition
#             # if (abs(currentPosition) == 0 or abs(currentPosition) == 100):
#             #     password += 1
#             #     password += abs(calc_zeros)
